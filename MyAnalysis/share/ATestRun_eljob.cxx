void ATestRun_eljob (const std::string& submitDir,int vers)
{
	...
	{
		sprintf(fileName,"data17_13TeV.00%i.physics_Main.deriv.DAOD_STDM7.*_p4030/", runNumber[vers]);
		//sprintf(fileName,"data17_13TeV.00%i.physics_BphysLS.deriv.DAOD_STDM7.*_p4030/", runNumber[vers]);
	}

	if(runNumber[vers] >= 348885)
 	{
		sprintf(fileName,"data18_13TeV.00%i.physics_Main.deriv.DAOD_STDM7.*_p4030/", runNumber[vers]);
		//sprintf(fileName,"data18_13TeV.00%i.physics_BphysLS.deriv.DAOD_STDM7.*_p4030/", runNumber[vers]);
	}
